// Builds time-series for supply-chain drivers relevant to
...
// - fuel costs
// - port congestion
// - weather-related transportation risk
// - manufacturing activity
// - regulatory/compliance costs
//
// Dependencies come from the Product & Material Agent.
// Values are initially seeded/mock and can be enriched with
// live Bright Data results.
...
const KEYWORD_DRIVERS: { kw: string[]; meta: DriverMeta }[] = [
  ...
  { kw: ["crude", "brent", "wti", "oil", "fuel", "diesel", "bbm", "bunker"], meta: { display: "Fuel Cost", unit: "idx", base: 100, drift: 6, affects: "Plastics, freight, fuel" } },
  ...
  { kw: ["freight", "ocean", "container", "truck", "rail", "air", "shipping rate"], meta: { display: "Domestic Freight", unit: "idx", base: 100, drift: 8, affects: "Domestic transportation cost" } },
...
//   { kw: ["currency", "exchange", "idr", "usd", "cny", "fx", "yuan", "forex"], meta: { display: "USD/IDR", unit: "rate", base: 7.18, drift: -1.5, affects: "FX on goods cost" } },
  { kw: ["labor", "wage", "workforce", "upah", "tenaga kerja"], meta: { display: "Domestic Labor Cost", unit: "idx", base: 100, drift: 4, affects: "Domestic manufacturing and handling costs" } },
  { kw: ["pmi", "manufacturing", "industri"], meta: { display: "Indonesia Manufacturing PMI", unit: "idx", base: 50.4, drift: -1, affects: "Domestic supplier and production activity" } },
...
function unknownMeta(dep: string): DriverMeta {
  ...
  return { display, unit, base, drift, affects: "Input to domestic shipment cost" };
}
...
export function buildDrivers(
  ...
  return dependencies
    ...
    .map((dep) => {
      ...
      else if (/freight|ocean|container|truck|rail|air/i.test(meta.display) && (freightFactor?.score ?? 0) >= 60) impact = "high";
